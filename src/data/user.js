const INFO = {
	...
	homepage: {
		...
		description:
			"Hi, I'm Colin Xiong, a Software Engineering student at McGill University. I’m currently working at a startup called meSO Groupe Inc., where I’m involved in developing scalable REST APIs and working on full-stack projects using technologies like React Native, Nest.js, and MongoDB. I’ve also had the chance to intern at Cisco and Bell Canada, where I worked on AI and LLM-based projects at Cisco, and complex event processing with Apache Flink at Bell, focusing on a variety of backend and frontend tasks.",
	},

	about: {
		title: "My name is Colin Xiong. I live in Montreal and study at McGill University.",
		description:
			"I've been involved in a range of projects throughout my time at McGill, as well as during my internships at Cisco, Bell Canada, and meSO Groupe Inc. I'm particularly proud of my work on complex event processing with Apache Flink at Bell and my contributions to AI and LLM-based projects at Cisco. Some of these projects are open-source, and I'd love for others to explore, contribute, or provide feedback. If you're interested in any of the projects I've worked on, feel free to check out the code. I'm always open to collaboration and new ideas, as it's a great way to continue learning and growing.",
	},
